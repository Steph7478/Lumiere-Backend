...
// public static final String FETCHGRAPH_HINT =
...
// public static <T> EntityGraph<T> build(EntityManager em, Class<T>
// entityClass, List<String> paths) {
...
// throw new IllegalArgumentException("Invalid path part in: " +
// String.join(".", parts));
// }
